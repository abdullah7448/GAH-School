<?php get_header();  ?>
 ...
 <div id="jsc_result">
	<div class="container">
		<h2>এসএসসি (SSC) ফলাফল, ২০০১ থেকে ২০১৬ পর্যন্ত</h2>
	    ...
	    <div class="markshit table-responsive">
			<table class="table">
				...
				<tr>
					...
					<td><?php $SGPA= get_post_meta(get_the_ID($zia->ID),'gpa_b_s', true) + get_post_meta(get_the_ID($zia->ID),'gpa_g_s', true); echo $SGPA; ?></td>
